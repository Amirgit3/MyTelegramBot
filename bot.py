...
яви: 1. **توقف ربات**:
   - یه تابع `shutdown` به کد اضافه کردم که به درستی ربات رو متوقف کنه و منابع رو آزاد کنه.
   - این تابع توی بخش `if __name__ == "__main__":` استفاده شده تا در صورت وقفه یا خطا، ربات به صورت تمیز خاموش بشه.
